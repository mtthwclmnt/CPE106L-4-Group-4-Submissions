...
def login_page(page):
    ...
    def submit_login(e):
        ...
        if not email.value.strip() or not password.value.strip():
            page.snack_bar = ft.SnackBar(content=ft.Text("Please fill in all fields"), bgcolor="red")
            page.snack_bar.open = True
            page.update()
            return
